...
saxonb-xslt -xsl:provision/konkordanz.xslt -s:/elb1912-konkordanz.xml -ext:on externalStrongDictFileName="/shared/provision/strong.xml" outputDirectory="/shared/demo/repo" > /dev/null
# Transform linklist
